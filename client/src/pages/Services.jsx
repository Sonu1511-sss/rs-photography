        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                key={service.title}
                className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 shadow-lg hover:shadow-2xl transition-all hover:border-wedding-gold"
              ...
              >
                ...
                <h3 className="text-2xl font-elegant font-bold mb-4 dark:text-white">
                  {service.title}
                </h3>
