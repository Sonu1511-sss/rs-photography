            ...
            {loading ? (
              ...
              <div className="text-center py-20">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-wedding-gold text-white px-6 py-3 rounded-lg font-semibold hover:bg-gold-400 transition-all"
                >
              ...
              <>
                ...
                >
                  ...
                  <p className="text-gray-600 text-lg">
                    Experience the magic of our cinematic wedding videos
                  </p>
                </motion.div>
                        ...
                        <div className="aspect-video relative overflow-hidden bg-gray-900">
                          ...
                          <div className="absolute inset-0 bg-black/40 group-hover:bg-black/60 transition-colors flex items-center justify-center">
                            <button
                              ...
                              className="bg-wedding-gold hover:bg-gold-400 text-white rounded-full p-4 transition-all transform group-hover:scale-110"
                            >
                              <FaPlay size={32} />
                            </button>
                          </div>
