...
const PortfolioWeddings = () => {
  ...
  useEffect(() => {
    api.get('/portfolio?category=weddings')
      .then(res => {
  ...
  return (
    <>
      <SEO 
        title="Wedding Photography Gallery - RS Photography"
        description="Browse our stunning wedding photography gallery featuring beautiful Indian weddings captured by RS Photography in Balaghat and Katangi."
        keywords="wedding photography, wedding photos, Indian wedding photography, wedding gallery"
      />
